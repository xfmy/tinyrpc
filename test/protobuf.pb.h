...
class user : public ::PROTOBUF_NAMESPACE_ID::Service {
 protected:
 ...
 private:
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(user);
};

class user_Stub : public user {
 public:
  user_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel);
  user_Stub(::PROTOBUF_NAMESPACE_ID::RpcChannel* channel,
 ...
 private:
  ...
  bool owns_channel_;
  GOOGLE_DISALLOW_EVIL_CONSTRUCTORS(user_Stub);
};
